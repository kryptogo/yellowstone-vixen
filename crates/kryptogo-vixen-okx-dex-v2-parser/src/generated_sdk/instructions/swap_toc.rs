...
impl SwapToc {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = SwapTocInstructionData::new().try_to_vec().unwrap();
...
pub struct SwapTocInstructionData {
    discriminator: [u8; 8],
}

impl SwapTocInstructionData {
    pub fn new() -> Self {
        Self {
...
impl SwapTocBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = SwapTocInstructionArgs {
...
/// `swap_toc` CPI accounts.
pub struct SwapTocCpiAccounts<'a, 'b> {
...
/// `swap_toc` CPI instruction.
pub struct SwapTocCpi<'a, 'b> {
    ...
    pub __args: SwapTocInstructionArgs,
}

impl<'a, 'b> SwapTocCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SwapTocCpiAccounts<'a, 'b>,
        args: SwapTocInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SwapToc` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   15. `[]` program
#[derive(Clone, Debug)]
pub struct SwapTocCpiBuilder<'a, 'b> {
    instruction: Box<SwapTocCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SwapTocCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SwapTocCpiBuilderInstruction {
            __program: program,
            payer: None,
...
#[derive(Clone, Debug)]
struct SwapTocCpiBuilderInstruction<'a, 'b> {
