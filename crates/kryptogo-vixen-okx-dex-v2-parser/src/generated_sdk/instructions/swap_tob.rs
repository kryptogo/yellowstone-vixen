...
pub const SWAP_TOB_DISCRIMINATOR: [u8; 8] = [170, 41, 85, 177, 132, 80, 31, 53];
...
impl SwapTob {
    pub fn instruction(&self, args: SwapTobInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = SwapTobInstructionData::new().try_to_vec().unwrap();
...
pub struct SwapTobInstructionData {
    discriminator: [u8; 8],
}

impl SwapTobInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for SwapTobInstructionData {
...
impl SwapTobInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> { borsh::to_vec(self) }
}

/// Instruction builder for `SwapTob`.
///
/// ### Accounts:
///
...
impl SwapTobBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = SwapTobInstructionArgs {
...
/// `swap_tob` CPI accounts.
pub struct SwapTobCpiAccounts<'a, 'b> {
...
/// `swap_tob` CPI instruction.
pub struct SwapTobCpi<'a, 'b> {
    ...
    pub __args: SwapTobInstructionArgs,
}

impl<'a, 'b> SwapTobCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SwapTobCpiAccounts<'a, 'b>,
        args: SwapTobInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SwapTob` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   15. `[]` program
#[derive(Clone, Debug)]
pub struct SwapTobCpiBuilder<'a, 'b> {
    instruction: Box<SwapTobCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SwapTobCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SwapTobCpiBuilderInstruction {
            __program: program,
            payer: None,
...
#[derive(Clone, Debug)]
struct SwapTobCpiBuilderInstruction<'a, 'b> {
