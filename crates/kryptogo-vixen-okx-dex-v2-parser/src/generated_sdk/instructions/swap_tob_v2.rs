...
pub const SWAP_TOB_V2_DISCRIMINATOR: [u8; 8] = [72, 1, 215, 242, 8, 75, 54, 216];

/// Accounts.
#[derive(Debug)]
pub struct SwapTobV2 {
...
impl SwapTobV2 {
    pub fn instruction(&self, args: SwapTobV2InstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = SwapTobV2InstructionData::new().try_to_vec().unwrap();
...
pub struct SwapTobV2InstructionData {
    discriminator: [u8; 8],
}

impl SwapTobV2InstructionData {
    pub fn new() -> Self {
        Self {
            discriminator: [72, 1, 215, 242, 8, 75, 54, 216],
        }
    }
...
impl Default for SwapTobV2InstructionData {
    fn default() -> Self { Self::new() }
}

#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTobV2InstructionArgs {
    pub args: SwapArgs,
...
impl SwapTobV2InstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> { borsh::to_vec(self) }
}

/// Instruction builder for `SwapTobV2`.
///
/// ### Accounts:
///
...
impl SwapTobV2Builder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = SwapTobV2InstructionArgs {
...
/// `swap_tob_v2` CPI accounts.
pub struct SwapTobV2CpiAccounts<'a, 'b> {
...
/// `swap_tob_v2` CPI instruction.
pub struct SwapTobV2Cpi<'a, 'b> {
    ...
    pub __args: SwapTobV2InstructionArgs,
}

impl<'a, 'b> SwapTobV2Cpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SwapTobV2CpiAccounts<'a, 'b>,
        args: SwapTobV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `SwapTobV2` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` payer
...
///   16. `[]` program
#[derive(Clone, Debug)]
pub struct SwapTobV2CpiBuilder<'a, 'b> {
    instruction: Box<SwapTobV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SwapTobV2CpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SwapTobV2CpiBuilderInstruction {
            __program: program,
            payer: None,
...
#[derive(Clone, Debug)]
struct SwapTobV2CpiBuilderInstruction<'a, 'b> {
