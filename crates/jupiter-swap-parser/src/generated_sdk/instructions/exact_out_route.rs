...
impl ExactOutRoute {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&ExactOutRouteInstructionData::new()).unwrap();
...
pub struct ExactOutRouteInstructionData {
    discriminator: [u8; 8],
}

impl ExactOutRouteInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for ExactOutRouteInstructionData {
...
///   8. `[optional]` token2022_program
///   9. `[optional]` event_authority (default to `D8cy77BBepLMngZx6ZukaTff5hCt1HrWyKk3Hnd9oitf`)
///   10. `[]` program
#[derive(Clone, Debug, Default)]
pub struct ExactOutRouteBuilder {
...
impl ExactOutRouteBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = ExactOutRouteInstructionArgs {
...
/// `exact_out_route` CPI accounts.
pub struct ExactOutRouteCpiAccounts<'a, 'b> {
...
/// `exact_out_route` CPI instruction.
pub struct ExactOutRouteCpi<'a, 'b> {
    ...
    pub __args: ExactOutRouteInstructionArgs,
}

impl<'a, 'b> ExactOutRouteCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: ExactOutRouteCpiAccounts<'a, 'b>,
        args: ExactOutRouteInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `ExactOutRoute` via CPI.
///
/// ### Accounts:
///
///   0. `[]` token_program
...
///   10. `[]` program
#[derive(Clone, Debug)]
pub struct ExactOutRouteCpiBuilder<'a, 'b> {
    instruction: Box<ExactOutRouteCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> ExactOutRouteCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(ExactOutRouteCpiBuilderInstruction {
            __program: program,
            token_program: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = ExactOutRouteCpi {
...
#[derive(Clone, Debug)]
struct ExactOutRouteCpiBuilderInstruction<'a, 'b> {
