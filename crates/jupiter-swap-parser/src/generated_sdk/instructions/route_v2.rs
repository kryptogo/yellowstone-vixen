...
impl RouteV2 {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = borsh::to_vec(&RouteV2InstructionData::new()).unwrap();
...
impl BorshDeserialize for RouteV2InstructionArgs {
    fn deserialize_reader<R: std::io::Read>(reader: &mut R) -> std::io::Result<Self> {
        // Fixed fields at beginning: in_amount(8) + quoted_out_amount(8) + slippage_bps(2) + platform_fee_bps(2) + positive_slippage_bps(2) = 22 bytes
...
impl<'a, 'b> RouteV2Cpi<'a, 'b> {
    pub fn new(
        ...
        accounts: RouteV2CpiAccounts<'a, 'b>,
        args: RouteV2InstructionArgs,
    ) -> Self {
        Self {
            __program: program,
