...
pub struct DepositBuilder {
    ...
    lp_token_amount_out: Option<u64>,
    max_base_amount_in: Option<u64>,
...
impl DepositBuilder {
    ...
    #[inline(always)]
    pub fn lp_token_amount_out(&mut self, lp_token_amount_out: u64) -> &mut Self {
        self.lp_token_amount_out = Some(lp_token_amount_out);
        self
    }

    #[inline(always)]
    pub fn max_base_amount_in(&mut self, max_base_amount_in: u64) -> &mut Self {
        self.max_base_amount_in = Some(max_base_amount_in);
        self
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = DepositInstructionArgs {
            lp_token_amount_out: self
                .lp_token_amount_out
                .clone()
                .expect("lp_token_amount_out is not set"),
            max_base_amount_in: self
                .max_base_amount_in
                .clone()
                .expect("max_base_amount_in is not set"),
...
impl<'a, 'b> DepositCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn lp_token_amount_out(&mut self, lp_token_amount_out: u64) -> &mut Self {
        self.instruction.lp_token_amount_out = Some(lp_token_amount_out);
        self
    }

    #[inline(always)]
    pub fn max_base_amount_in(&mut self, max_base_amount_in: u64) -> &mut Self {
        self.instruction.max_base_amount_in = Some(max_base_amount_in);
        self
    }
