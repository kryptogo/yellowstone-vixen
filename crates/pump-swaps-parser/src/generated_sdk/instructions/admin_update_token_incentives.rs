...
pub struct AdminUpdateTokenIncentivesBuilder {
    ...
    token_supply_per_day: Option<u64>,
...
impl AdminUpdateTokenIncentivesBuilder {
    ...
    #[inline(always)]
    pub fn token_supply_per_day(&mut self, token_supply_per_day: u64) -> &mut Self {
        self.token_supply_per_day = Some(token_supply_per_day);
        self
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = AdminUpdateTokenIncentivesInstructionArgs {
            ...
            token_supply_per_day: self
                .token_supply_per_day
                .clone()
                .expect("token_supply_per_day is not set"),
        };
...
impl<'a, 'b> AdminUpdateTokenIncentivesCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn token_supply_per_day(&mut self, token_supply_per_day: u64) -> &mut Self {
        self.instruction.token_supply_per_day = Some(token_supply_per_day);
        self
    }
