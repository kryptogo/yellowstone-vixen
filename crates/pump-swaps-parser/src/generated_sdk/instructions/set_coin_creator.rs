...
pub const SET_COIN_CREATOR_DISCRIMINATOR: [u8; 8] = [210, 149, 128, 45, 188, 58, 78, 175];
...
impl SetCoinCreator {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = SetCoinCreatorInstructionData::new().try_to_vec().unwrap();
...
pub struct SetCoinCreatorInstructionData {
    discriminator: [u8; 8],
}

impl SetCoinCreatorInstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct SetCoinCreatorBuilder {
...
/// `set_coin_creator` CPI accounts.
pub struct SetCoinCreatorCpiAccounts<'a, 'b> {
...
/// `set_coin_creator` CPI instruction.
pub struct SetCoinCreatorCpi<'a, 'b> {
...
impl<'a, 'b> SetCoinCreatorCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: SetCoinCreatorCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
            pool: accounts.pool,
...
/// Instruction builder for `SetCoinCreator` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` pool
...
///   4. `[]` program
#[derive(Clone, Debug)]
pub struct SetCoinCreatorCpiBuilder<'a, 'b> {
    instruction: Box<SetCoinCreatorCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetCoinCreatorCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(SetCoinCreatorCpiBuilderInstruction {
            __program: program,
            pool: None,
            metadata: None,
            bonding_curve: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = SetCoinCreatorCpi {
...
#[derive(Clone, Debug)]
struct SetCoinCreatorCpiBuilderInstruction<'a, 'b> {
