...
impl BorshDeserialize for BuyInstructionArgs {
    fn deserialize_reader<R: std::io::Read>(reader: &mut R) -> std::io::Result<Self> {
        // Required fields - must be present
        let base_amount_out = u64::deserialize_reader(reader)?;
        let max_quote_amount_in = u64::deserialize_reader(reader)?;
...
pub struct BuyBuilder {
    ...
    protocol_fee_recipient_token_account: Option<solana_pubkey::Pubkey>,
    ...
    base_amount_out: Option<u64>,
    max_quote_amount_in: Option<u64>,
...
impl BuyBuilder {
    ...
    pub fn protocol_fee_recipient_token_account(
        &mut self,
        protocol_fee_recipient_token_account: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    #[inline(always)]
    pub fn base_amount_out(&mut self, base_amount_out: u64) -> &mut Self {
        self.base_amount_out = Some(base_amount_out);
        self
    }

    #[inline(always)]
    pub fn max_quote_amount_in(&mut self, max_quote_amount_in: u64) -> &mut Self {
        self.max_quote_amount_in = Some(max_quote_amount_in);
        self
    }
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = BuyInstructionArgs {
            base_amount_out: self
                .base_amount_out
                .clone()
                .expect("base_amount_out is not set"),
            max_quote_amount_in: self
                .max_quote_amount_in
                .clone()
                .expect("max_quote_amount_in is not set"),
...
impl<'a, 'b> BuyCpiBuilder<'a, 'b> {
    ...
    pub fn protocol_fee_recipient_token_account(
        &mut self,
        protocol_fee_recipient_token_account: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    #[inline(always)]
    pub fn base_amount_out(&mut self, base_amount_out: u64) -> &mut Self {
        self.instruction.base_amount_out = Some(base_amount_out);
        self
    }

    #[inline(always)]
    pub fn max_quote_amount_in(&mut self, max_quote_amount_in: u64) -> &mut Self {
        self.instruction.max_quote_amount_in = Some(max_quote_amount_in);
        self
    }
